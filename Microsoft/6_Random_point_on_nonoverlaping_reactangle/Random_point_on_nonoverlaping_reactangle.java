// package Microsoft.6_Random_point_on_nonoverlaping_reactangle;
import java.util.*;

public class Random_point_on_nonoverlaping_reactangle {
    
        Random random;
        TreeMap<Integer,int[]> map;
        int areaSum = 0;
        
        public Random_point_on_nonoverlaping_reactangle(int[][] rects) {
